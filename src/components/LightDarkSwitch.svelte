...
function showPanel() {
	...
	if (!panel) return; // 무슨 용도인지 정확하게 모름
...
<div class="relative z-50" role="menu" tabindex="-1" onmouseleave={hidePanel}>
    ...
    <div id="light-dark-panel" class="hidden lg:block absolute transition float-panel-closed top-11 -right-2 pt-5" >
        <div class="card-base float-panel p-2">
            ...
            >
                <Icon icon={icons[LIGHT_MODE]} class="text-[1.25rem] mr-3"></Icon>
            ...
            >
                <Icon icon={icons[DARK_MODE]} class="text-[1.25rem] mr-3"></Icon>
            ...
            >
                <Icon icon={icons[AUTO_MODE]} class="text-[1.25rem] mr-3"></Icon>
