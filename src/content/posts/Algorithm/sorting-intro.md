...
알고리즘 교과서(CLRS)를 펴면 가장 먼저 나오는게 정렬 문제다.
...
이 두 친구는 CLRS에서 예제나 실습으로 언급되고 마는 녀석들
<br>
실질적으로는 삽입 정렬, 병합 정렬, 힙 정렬, 그리고 퀵 정렬을 정확하게 공부하는게 중요함

- 선택 정렬, 버블 정렬 <- 이렇게 생겼구나
<br>
- 안정성(Stability)이 중요한 상황도 있구나
<br>
하고 넘어가자